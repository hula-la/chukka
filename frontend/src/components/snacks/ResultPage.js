...
const ResultPage = () => {
  ...
  useEffect(() => {
    ...
    let totalCnt = data[0].count + data[1].count + data[2].count;
    let maxScore = totalCnt * 1000;

    setRankIdx(Math.floor(5*Math.min(total/maxScore,4)))
    ...
    <Rainbow>
      <GameResult className="background">
        ...
        <Content>
          ...
          <DetailScore>
            <Rank src={require(`../../img/${rankImgData[rankIdx]}`)}></Rank>
