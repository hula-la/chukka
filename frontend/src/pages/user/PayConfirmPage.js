    ...
    <Wrapper>
      <Content>
        ...
        <Summary>
          ...
          <span className="span-right">{state.amount} 원</span>
        </Summary>
      </Content>

      <Buttons>
        <Link to="/lectures">
          <Button content="강의 더보기" />
        </Link>
        <Link to={`/accounts/profile/${state.user.userNickname}/2`}>
          <Button content="내 수강목록" />
        </Link>
      </Buttons>
    </Wrapper>
  ) : (
