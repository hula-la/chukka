...
class VideoRoomComponent extends Component {
  constructor(props) {
    ...
    this.OPENVIDU_SERVER_URL = this.props.openviduServerUrl
      ? this.props.openviduServerUrl
      : 'http://' + window.location.hostname + ':5443';
    ...
    let userName = this.props.user
      ? this.props.user
      : '수강생' + Math.floor(Math.random() * 100);
    this.remotes = [];
    ...
    this.handleChangeMySessionId = this.handleChangeMySessionId.bind(this);
    this.handleChangeMyUserName = this.handleChangeMyUserName.bind(this);
    this.onSubmitStartSession = this.onSubmitStartSession.bind(this);
  }
  ...
  handleChangeMySessionId(e) {
    this.setState({
      mySessionId: e.target.value,
    });
  }

  handleChangeMyUserName(e) {
    this.setState({
              ...
              >
                <p>
                  ...
                  <input
                    ...
                    onChange={(e) => this.handleChangeMyUserName(e)}
                    required
                  />
                </p>
                <p>
                  ...
                  <input
                    ...
                    onChange={(e) => this.handleChangeMySessionId(e)}
                    required
                  />
                </p>
            ...
            <div className="layouttest">
              <div id="layout" className="bounds" style={{ width: '50%' }}>
                {this.state.subscribers.map((sub, i) => {
                  if (
                    sub.nickname === this.state.mySessionId ||
