    ...
    <Wrapper>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='input-container'>
          ...
          <StyledInput id="lecTitle" name="lecTitle" onChange={onChange}  placeholder='강사 제목을 입력해주세요' autoComplete='off'/>
        </div>        
        <div className='input-container'>
          <StyledLabel for="lecContents">내용</StyledLabel>
          <StyledInput id="lecContents" name="lecContents" onChange={onChange}  placeholder='내용을 입력해주세요' autoComplete='off'/>
        </div>
        <div className='input-container'>
          ...
          <StyledInput
            ...
            name="lecPrice"
            onChange={onChange}
            placeholder='가격을 입력해주세요' autoComplete='off'
          />
        </div>
        <div className='input-container'>
